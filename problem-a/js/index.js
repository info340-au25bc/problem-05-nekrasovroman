...
if (motto.indexOf('cool') == -1) {
    ...
    console.log(motto.indexOf('cool'));
}
...
let ratio = motto.length / oldMotto.length;
...
if (sortedNumbers.length % 2 === 0) {
  median = Math.floor((sortedNumbers[sortedNumbers.length / 2 - 1] + sortedNumbers[sortedNumbers.length / 2]) / 2);
} else {
